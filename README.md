...
Сімейний застосунок на двох: задачі в стилі Linear і домашні гроші через проєкти —
витрати з орієнтиром на місяць, накопичення, борги, регулярні платежі, спільний
список покупок. Інтерфейс українською.
...
База: Supabase, міграції з `sql/` по порядку (01, 02, 06–14).
