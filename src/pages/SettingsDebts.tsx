...
import { useDB, debtStatus, addDebt, updateDebt, closeDebt, reopenDebt } from '../data/store'
...
export default function SettingsDebts() {
  const db = useDB()
  ...
  return (
    <div className="max-w-[760px] mx-auto pb-8">
      <header className="px-4 pt-5 pb-3 sm:px-6 flex items-start justify-between gap-3">
        ...
        <Btn variant="primary" onClick={openNew}>{Icon.plus(16)}Додати</Btn>
      </header>
      ...
      {db.debts.length === 0 ? (
        <Empty>
          <p className="max-w-[420px] mx-auto">
            ...
            і до якої дати хочемо закрити. Покажемо, чи встигаємо.
          </p>
              ...
              return (
                <Card key={d.id}>
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <Btn variant="quiet" onClick={() => openEdit(d)}>{Icon.pencil(16)}Змінити</Btn>
                  </div>
                  ...
                  <Card key={d.id}>
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <IconButton label="Змінити" onClick={() => openEdit(d)}>{Icon.pencil(16)}</IconButton>
