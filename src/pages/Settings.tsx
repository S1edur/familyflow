 ...
 * Проєкти й їхні правила редагуються на сторінці проєкту, шаблони задач —
 * на «Задачах». Тут лише те, що не має свого екрана, і вхід до розділів,
 * яких немає в таб-барі.
 */
const SCREENS = [
  { to: '/projects',  label: 'Проєкти',  hint: 'Витрати, накопичення, борги й задачі до мети', icon: Icon.piggy },
  { to: '/month',     label: 'Місяць',   hint: 'Що заплатити, скільки відкласти, прогноз',     icon: Icon.calendar },
  { to: '/shopping',  label: 'Покупки',  hint: 'Спільний список і походи',                     icon: Icon.cart },
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <p className="px-4 sm:px-6 mt-4 text-[12.5px] text-faint leading-snug">
        Проєкти, їхні регулярні платежі й гроші редагуються на сторінці проєкту,
        повторювані побутові задачі — на «Задачах». Там, де їх видно.
      </p>
    </div>
  )
}
