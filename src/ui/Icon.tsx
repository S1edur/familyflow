...
export const Icon = {
  ...
  bell:  (s?: number) => <S size={s} d="M18 9a6 6 0 1 0-12 0c0 5-2 6-2 6h16s-2-1-2-6zM13.7 20a2 2 0 0 1-3.4 0" />,
  pin:   (s?: number) => <S size={s} d="M12 17v5M9 3h6l-1 6 3 3v2H7v-2l3-3-1-6z" />,
  calendar: (s?: number) => <S size={s} d="M4 6.5A1.5 1.5 0 0 1 5.5 5h13A1.5 1.5 0 0 1 20 6.5v12a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 18.5zM4 10h16M8.5 3v4M15.5 3v4M8 14h.01M12 14h.01M16 14h.01" />,
