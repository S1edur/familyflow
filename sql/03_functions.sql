-- ============================================================================
-- ⚠ ЗАСТАРІЛО. Не виконувати на новій базі.
-- Серверна генерація платежів і задач розійшлась із клієнтом (інші id, не знає
-- deleted_at і внесків у фонди), а вʼюхи обходили RLS. Усе це прибирає
-- 13_hardening.sql; генерація живе в src/data/store.ts → materialize().
-- Файл лишається як історія рішень.
-- ============================================================================
